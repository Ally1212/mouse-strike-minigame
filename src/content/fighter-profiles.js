...
export const FIGHTERS = {
  hypersonic: {
    ...
    tradeoff: "全员免费开放；强袭形态仍需在战斗中收集 3 个能量球",
  ...
  j35: {
    ...
    passiveId: "dual-lock",
    passiveName: "双线锁定",
    passive: "追踪弹命中后建立双线标记，被动蓄满时自动对标记目标发动连续截击。",
    strength: "高机动、快速变形、追踪与近距爆发兼备",
    tradeoff: "持续重火力弱于重型机，需要持续建立标记来加快被动循环",
  ...
  f22: {
    ...
    passiveName: "幽灵标记",
    passive: "追踪弹命中后标记目标，专属被动会优先处决全部标记单位。",
  ...
  su57: {
    ...
    passiveName: "反应蓄能",
    passive: "强袭装甲吸收伤害时储存反击能量，专属被动会将能量转为额外爆破。",
